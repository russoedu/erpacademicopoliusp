...
<ul class="actions">
	...
	<li><?php echo CHtml::link('Atualizar biblioteca',array('update','id'=>$model->id_biblioteca)); ?></li>
	<li><?php echo CHtml::linkButton('Deletar biblioteca',array('submit'=>array('delete','id'=>$model->id_biblioteca),'confirm'=>'Tem certeza?')); ?></li>
